...
- name: Azure Data Lake Store API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/firewall/master/_listings/azure-data-lake-store/subscriptions-subscriptionid-resourcegroups-resourcegroupname-providers-microsoft-datalakestore-accounts-accountname-firewallrules-firewallrulename-patch.md
x-common:
